<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RESTARAUNT.aspx.vb" Inherits="hotel.RESTARAUNT" %>
...
<div class="w3-dropdown-hover w3-hide-small">
    ...
    <a href="GALLEY.aspx" class="w3-bar-item w3-button w3-padding-large w3-hide-small">GALLERY</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <form id="form1" runat="server" style="text-align:left;margin-top:0px;color:black; width:95%; margin-top:0px" class="container" >
    <h1> RESTAURANT REGISTRATION</h1>
      <img src="photo/pasta.jpg"  style="height:250px;width:390px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
      <img src="photo/rice%20and%20chicken.jpg"  style="height:250px;width:390px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <img src="photo/christmas-sunrise.jpg"style="height:250px;width:390px"/>
    
    <p>Please fill in this form to create an account.</p>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <asp:Label ID="Label12" runat="server" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
          &nbsp;</p>
    <hr/>
    ...
    <asp:TextBox ID="TxtID" runat="server" placeholder="Enter UserID"> </asp:TextBox>
    ...
    <asp:TextBox ID="Txtfname" runat="server" placeholder="Enter First Name"> </asp:TextBox>

    <label for="fname"><b>Last Name</b></label>&nbsp;
    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Required" ControlToValidate="Txtlname" ForeColor="#FF3300"></asp:RequiredFieldValidator>--%>
    <asp:TextBox ID="Txtlname" runat="server" placeholder="Enter Last Name"> </asp:TextBox>

    <label for="food type"><b>Food Type</b></label> 
    <asp:DropDownList ID="Dropfoods" runat="server" style="width: 100%; padding: 15px;margin: 5px 0 22px 0; display: inline-block;border: none;background: #f1f1f1">
          <asp:ListItem Value="1">Pasta</asp:ListItem>
          <asp:ListItem Value="2">Pasta And Chicken</asp:ListItem>
          <asp:ListItem Value="3">Rice</asp:ListItem>
          <asp:ListItem Value="4">Rice And Chicken</asp:ListItem>
          <asp:ListItem Value="5">Chicken</asp:ListItem>
          <asp:ListItem Value="6">Meat</asp:ListItem>
          <asp:ListItem Value="7">Dry Fish </asp:ListItem>
          <asp:ListItem Value="8">Fish And Sea Food</asp:ListItem>
          <asp:ListItem Value="9">Grilled Fish </asp:ListItem>
          <asp:ListItem Value="10">shuwarma</asp:ListItem>
          <asp:ListItem Value="11">Chips</asp:ListItem>
          <asp:ListItem Value="12">Fish Burger</asp:ListItem> 
          <asp:ListItem Value="13">Sea Food</asp:ListItem>
          <asp:ListItem Value="14">Chicken Burger</asp:ListItem>
          <asp:ListItem Value="15">ChickenPizza</asp:ListItem>
          <asp:ListItem Value="16">Fish Pizza</asp:ListItem>
          <asp:ListItem Value="17">Sambusa</asp:ListItem>
          <asp:ListItem Value="18">pancakes</asp:ListItem>
          <asp:ListItem Value="19">Fruits</asp:ListItem>

      </asp:DropDownList>
       
      &nbsp;<label for="room want"><b>Juice Type</b></label> 
      <asp:DropDownList ID="Dropdrinks" runat="server" style="width: 100%; padding: 15px;margin: 5px 0 22px 0; display: inline-block;border: none;background: #f1f1f1">
          <asp:ListItem Value="1">Mango</asp:ListItem>
          <asp:ListItem Value="2">Lemon</asp:ListItem>
          <asp:ListItem Value="3">Watermaelon</asp:ListItem>
          <asp:ListItem Value="4">Spondias</asp:ListItem>
          <asp:ListItem Value="5">MangoShake</asp:ListItem>
          <asp:ListItem Value="6">Olive</asp:ListItem>
          <asp:ListItem Value="7">Avocado</asp:ListItem>
          <asp:ListItem Value="8">Orange</asp:ListItem>
          <asp:ListItem Value="9">Milk</asp:ListItem>
          <asp:ListItem Value="10">Milk Shake</asp:ListItem>
          <asp:ListItem Value="11">Banana Shake</asp:ListItem>
          <asp:ListItem Value="12">MangoShake</asp:ListItem>
      </asp:DropDownList>
        
      <label for="member"><b>Foods And Juices You Want</b></label>&nbsp;
      <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Required" ControlToValidate="Txtdrinkswant" ForeColor="#FF3300"></asp:RequiredFieldValidator>--%>
      <asp:TextBox ID="Txtdrinkfoodwant" runat="server" placeholder="Enter Juices And Foods You Want"> </asp:TextBox>
    ...
    <asp:TextBox ID="Txtphone" placeholder="Enter Phone Number" runat="server"></asp:TextBox>
   ...
   <%-- <div class="clearfix">
    ...
    <br />
      ...
      <form id="form2" runat="server" style="width:95%">
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EmptyDataText="There are no data records to display." DataSourceID="SqlDataSource2" AllowPaging="True" AllowSorting="True" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
...
<asp:BoundField DataField="DrinkType" HeaderText="DrinkType" SortExpression="DrinkType"></asp:BoundField>
<asp:BoundField DataField="Foods_And_Drinks_Want" HeaderText="Foods_And_Drinks_Want" SortExpression="Foods_And_Drinks_Want"></asp:BoundField>
...
<asp:BoundField DataField="AmountDeposited" HeaderText="AmountDeposited" SortExpression="AmountDeposited"></asp:BoundField>
 ...
 <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:HOTEL1ConnectionString %>" ProviderName="<%$ ConnectionStrings:HOTEL1ConnectionString.ProviderName %>" SelectCommand="SELECT [UserID], [Fname], [Lname], [FoodType], [DrinkType], [Foods_And_Drinks_Want], [Date], [Email], [Address], [PhoneNo], [AmountDeposited] FROM [restaraunt]" ID="SqlDataSource2"></asp:SqlDataSource>
