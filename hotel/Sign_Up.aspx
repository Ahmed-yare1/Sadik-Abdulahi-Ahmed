<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Sign_Up.aspx.vb" Inherits="hotel.Sign_Up"%>
                        ...
                        <div id="login" class="animate form">
                            <form id="form1" runat="server">
                                ...
                                <p> 
                                    ...
                                    <asp:TextBox ID="Txtfname" runat="server"  required="required" type="text" placeholder="Enter First Name" ></asp:TextBox>

                                </p>

                                <p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Last Name</label>
                                    <asp:TextBox ID="Txtlname" runat="server" required="required"  type="text"  placeholder="Enter Last Name" ></asp:TextBox>
                                </p>
                                <p> 
                                ...
                                <p> 
                                 ...
                                 <p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Date Of Bith</label>
                                    <asp:TextBox ID="Txtbirth" runat="server" required="required"  type="date" ></asp:TextBox>
                                </p>

                   
                                <p> 
                                    <label for="passwordsignup" class="youpasswd" data-icon="p">password</label>
                                    <asp:TextBox ID="Txtpass" runat="server" required="required" type="password" placeholder="Enter Password eg. X8df!90EO" ></asp:TextBox>
                                </p>
